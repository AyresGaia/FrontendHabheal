  ...
  return (
    <>
      {articles.map((a) => (
        <div
          key={a._id}
          onClick={() => handleArticleClick(a._id)}
          className="flex items-center gap-10 max-w-[1100px] mx-auto my-12 px-5 cursor-pointer
        ...
        >
          ...
          <div className="flex-1">
            {/* Category Chip (now functional) */}
            <span
              onClick={(e) => handleCategoryClick(e, a.category)}
              className="inline-block px-4 py-1 text-xs font-semibold tracking-wide
                         text-blue-700 bg-blue-50 rounded-full mb-2 hover:bg-blue-100 transition cursor-pointer"
            >
              {a.category}
            </span>
